...
export function SplitModalShell({ title, subtitle, onClose, width = 850, leftPanel, rightPanel }) {
  return (
    <div style={{ background: "var(--bg-surface)", borderRadius: "var(--radius-xl)", width: "100%", maxWidth: `${width}px`, minHeight: "500px", position: "relative", boxShadow: "var(--shadow-xl)", overflow: "hidden", border: "1px solid var(--border)", display: "flex" }}>
      ...
      {/* Right Panel */}
      <div style={{ flex: 1, padding: "48px", display: "flex", flexDirection: "column", position: "relative" }}>
