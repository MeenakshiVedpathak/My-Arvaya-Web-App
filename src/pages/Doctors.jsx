...
import { Search, ChevronRight, ThumbsUp, MapPin, Calendar, CheckCircle2, Clock, ShieldCheck } from "lucide-react";
            ...
            <div className="flex flex-col gap-6">
              ...
              <div>
                ...
                <div className="flex gap-2">
                  <button className="badge" style={{ background: 'var(--bg-app)', border: '1px solid var(--border)', padding: '6px 12px', fontWeight: 'normal', color: 'var(--text-main)', transition: 'all 0.2s', cursor: 'pointer' }} onMouseOver={e => { e.currentTarget.style.borderColor = 'var(--primary)'; e.currentTarget.style.background = 'var(--primary-light)'; }} onMouseOut={e => { e.currentTarget.style.borderColor = 'var(--border)'; e.currentTarget.style.background = 'var(--bg-app)'; }}>Male Doctor</button>
                  <button className="badge" style={{ background: 'var(--bg-app)', border: '1px solid var(--border)', padding: '6px 12px', fontWeight: 'normal', color: 'var(--text-main)', transition: 'all 0.2s', cursor: 'pointer' }} onMouseOver={e => { e.currentTarget.style.borderColor = 'var(--primary)'; e.currentTarget.style.background = 'var(--primary-light)'; }} onMouseOut={e => { e.currentTarget.style.borderColor = 'var(--border)'; e.currentTarget.style.background = 'var(--bg-app)'; }}>Female Doctor</button>
                </div>
              </div>
              ...
              <div>
                <b className="text-main mb-3" style={{ fontSize: '14px', display: 'block' }}>Languages Spoken</b>
                <div className="flex flex-col gap-2 text-muted" style={{ fontSize: '13px' }}>
                  <label className="flex items-center gap-2 cursor-pointer"><input type="checkbox" /> English</label>
                  <label className="flex items-center gap-2 cursor-pointer"><input type="checkbox" /> Hindi</label>
                  <label className="flex items-center gap-2 cursor-pointer"><input type="checkbox" /> Kannada</label>
                  <label className="flex items-center gap-2 cursor-pointer"><input type="checkbox" /> Telugu</label>
                </div>
              </div>

              <div>
                <b className="text-main mb-3" style={{ fontSize: '14px', display: 'block' }}>Hospital Network</b>
                <div className="flex flex-col gap-2 text-muted" style={{ fontSize: '13px' }}>
                  <label className="flex items-center gap-2 cursor-pointer"><input type="checkbox" /> Arvaya Care Network</label>
                  <label className="flex items-center gap-2 cursor-pointer"><input type="checkbox" /> Apollo Hospitals</label>
                  <label className="flex items-center gap-2 cursor-pointer"><input type="checkbox" /> Fortis Healthcare</label>
                  <label className="flex items-center gap-2 cursor-pointer"><input type="checkbox" /> Manipal Hospitals</label>
                </div>
              </div>
            </div>
          </div>
