...
function getHeader(activePage = 'Home') {
  ...
  return `
    <header className="glass" style="position: sticky; top: 0; z-index: 100; background: rgba(255, 255, 255, 0.95); backdrop-filter: blur(12px); border-bottom: 1px solid var(--border);">
...
function getFooter() {
  return `
    ...
    <div id="loginModal" style="display: none; position: fixed; inset: 0; background: rgba(0,0,0,0.6); backdrop-filter: blur(4px); z-index: 1000; align-items: center; justify-content: center; padding: 20px;">
      <div style="background: white; border-radius: 20px; max-width: 440px; width: 100%; padding: 32px; box-shadow: var(--shadow-xl); position: relative; animation: fadeInUp 0.3s ease;">
        ...
        <button onclick="alert('Static Mock OTP sent: 123456'); document.getElementById('loginModal').style.display='none';" class="btn btn-primary w-full" style="width: 100%; padding: 14px; font-size: 15px; font-weight: 700; border-radius: 12px;">Get OTP</button>
      </div>
    </div>
  `;
}
...
const doctorsContent = `
  <div class="container" style="padding: 40px 24px;">
    ...
    <div style="display: grid; grid-template-columns: repeat(auto-fill, minmax(340px, 1fr)); gap: 24px;">
      ...
      <!-- Doctor 1 -->
      <div style="background: white; border: 1px solid var(--border); border-radius: var(--radius-lg); padding: 24px; box-shadow: var(--shadow-md); transition: transform 0.2s;">
...
// ─────────────────────────────────────────────────────────────
// 3. DOCTOR PROFILE PAGE (doctor.html)
// ─────────────────────────────────────────────────────────────
const doctorContent = `
  <div class="container" style="padding: 40px 24px;">
    <div style="display: grid; grid-template-columns: 2fr 1fr; gap: 32px; align-items: start;">
      ...
      <div style="background: white; border: 1px solid var(--border); border-radius: var(--radius-lg); padding: 24px; box-shadow: var(--shadow-md); position: sticky; top: 100px;">
        ...
        <button onclick="alert('Appointment booked successfully with Dr. Priya Sharma!')" class="btn btn-primary w-full" style="width: 100%; padding: 14px; font-size: 15px; font-weight: 700;">Confirm Booking</button>
      </div>
...
// ─────────────────────────────────────────────────────────────
// 6. AMBULANCE PAGE (ambulance.html)
// ─────────────────────────────────────────────────────────────
